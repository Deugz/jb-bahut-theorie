...
- Le commanditaire souhaite une plateforme simple, qui ne nécéssite pas détape d'inscription. L'objectif principale selon lui est de ne pas faire peur à l'apprenant, mais bien de l'acceuillir avec bienveillance au sein de l'écocystème florissant de l'association. Mon premier partis pris, qui est un choix fort, sera de ne pas respecter la consigne de l'exercice et de créer un site documentaire (qui utilise la technologie sphinx) {numref}`Figure {number}: <Capture-Acceuil>` 


- Je pense cette plateforme comme un receuil documentaire 
    - Le bénévole sera libre d'y retourner dans le futur pour récupérer ou se remémorer les inforamtions, document hébérgés sur la plateforme 
    - pas de sons ou voix off puisque la platforme a vocation a être réutilisé, et je trouve dans ce cas un format sans son et statique plus adapté
    
- Je met des liens direct vers les plateformes de discussions et de partage d'information de l'asociation. Ainsi en plus de créer ses propres connaissances, l'apprenant aura acces aux sources d'intelligence collective de l'assocciation. 
...
J'ai éssayé de réfléchir l'architecture général du parcours en me mettant à la place d'un potentiel bénévole. Me considérant comme un **persona** représentatif de la cible, j'ai pensé que c'était un choix pertinent. L'infographie ci-dessous représente

```

<div style="width: 100%;"><div style="position: relative; padding-bottom: 100%; padding-top: 0; height: 0;"><iframe title="Genially sans titre" frameborder="0" width="800" height="800" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genially.com/6714e74577fb413238e55e6e" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe> </div> </div>
